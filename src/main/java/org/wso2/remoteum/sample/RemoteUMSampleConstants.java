...
public class RemoteUMSampleConstants {
    ...
    public static final String CLAIM_OPERATION = "claim.operation";
    public static final String CLAIM_DIALECT_URI ="claim.dialect.uri";
    public static final String CLAIM_URI = "claim.uri";
    public static final String DISPLAY_NAME = "display.name";
    public static final String CLAIM_DESCRIPTION = "claim.description";
    public static final String REGULAR_EXPRESSION = "regular.expression";
    public static final String DISPLAY_ORDER = "display.order";
    public static final String SUPPORTED_BY_DEFAULT = "supported.by.default";
    public static final String REQUIRED_FOR_CLAIM = "required.for.claim";
    public static final String READ_ONLY = "read.only";
    public static final String ATTRIBUTE_NAME_1 = "attribute.name.1";
    public static final String USER_STORE_DOMAIN_1 = "user.store.domain.1";
